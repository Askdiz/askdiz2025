...
const seriesData = [
    {
        ...
        description: "انضم أشرف إلى المافيا وأصبح أحد أقوى رجالها، بينما يواصل بحثه لسنوا",
        ...
        rumbleEpisodes: [
            "5fb4e54a8f",      // الحلقة 1 - المشغل الثاني (كما طلبت)
            "74afeaa72d",     // الحلقة 2 - المشغل الثاني (استخدمت المعرف الموجود)
        ...
        episodeDetails: [
            "الحلقة 1:في الحلقة الأولى من حلم أشرف (2025)، ينكشف ماضي غامض لبطلٍ عاش بين الخطر والظلام، ليعود اليوم أقوى وأكثر غموضًا. في لحظة غير متوقعة، يلتقي بفتاة تُشعل داخله ما ظنّ أنه مات منذ زمن... لكن خلف ذلك اللقاء حلمٌ يحمل وجعًا، وسرًّا قد يغيّر مصيرهما إلى الأبد..",
